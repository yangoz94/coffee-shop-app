    ...
    <div className={classes.about}>
      <div className={classes.about__div}>
        ...
        <p>
          ...
          Seattle’s historic Pike Place Market. It was here where Princeton
          ...
          captivated with Princeton coffee from his first sip. After joining the
          ...
          to bring the warmth and artistry of its coffee culture to Princeton.
          By 1997, we swapped our brown aprons for green ones and embarked on
          our next chapter as a coffeehouse.
          <br></br>
          <br></br>
          Princeton would soon expand to Chicago and Vancouver, Canada and then
          ...
          <span>
            *Copied from Starbucks website as a dummy text for learning purposes
            <br></br>
            **Starbucks was replaced with "Princeton" in the text
            <br></br>
